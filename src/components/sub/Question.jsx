  ...
  return (
    ...
    >
      <h1
        ...
        className={`flex items-center text-xl font-extralight text-gray-800 hover:text-yellow-600 tracking-wide cursor-pointer ${
      ...
      <motion.p
        initial={{ scalY: 0, height: 0, opacity: 0 }}
